...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-slate-950 text-white">
      ...
      <div className="absolute right-0 top-16 hidden w-[42rem] translate-x-20 lg:block">
        <div className="rounded-lg border border-white/15 bg-white/10 p-4 shadow-2xl backdrop-blur">
          <div className="mb-4 flex items-center justify-between border-b border-white/10 pb-3">
            ...
            <div className="rounded-md bg-orange-500 px-3 py-1 text-xs font-semibold text-white">
              Soon
            </div>
          </div>
              ...
              (request, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-md bg-blue-500/25 text-sm font-bold text-blue-100">
                      {index + 1}
                    </div>
                    <div>
                  ...
                  <span className="rounded-md bg-white/10 px-2 py-1 text-xs text-orange-100">
                    Match
                  </span>
                </div>
              )
